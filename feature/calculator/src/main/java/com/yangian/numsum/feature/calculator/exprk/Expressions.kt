package com.yangian.numsum.feature.calculator.exprk

import com.yangian.numsum.feature.calculator.exprk.internal.Evaluator
import com.yangian.numsum.feature.calculator.exprk.internal.Expr
import com.yangian.numsum.feature.calculator.exprk.internal.Function
import com.yangian.numsum.feature.calculator.exprk.internal.Parser
import com.yangian.numsum.feature.calculator.exprk.internal.Scanner
import com.yangian.numsum.feature.calculator.exprk.internal.Token
...
class Expressions {
    ...
    fun eval(expression: String): String {
        return try{
            evaluator.eval(parse(expression)).toString()
        } catch(e: Exception) {
            "NaN"
        }
    }
